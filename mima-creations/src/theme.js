// Shared color palette for both the public site and the admin dashboard.
// Import colors from here (or from adminTheme.js / SiteComponents.jsx,
// which re-export these same values) so the two never drift apart.
